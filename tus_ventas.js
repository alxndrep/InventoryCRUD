...
$(document).ready(function() {
    opcion = 10;
    vendedor = $.trim($('#user_username').html());
        ...
        success: function(data)
        {
            ...
            $('#ventaProductos > tbody > tr').each(function(){
                $('#borradorProductosBody').append(` <tr>
                                                        ...
                                                        <td style="text-align: right">${$(this).find('td:eq(4)').text()}</td>
                                                        <td style="text-align: right">${$(this).find('td:eq(5)').text()}</td>
                                                    </tr>`);
            });
            $('#borradorNeto').text($('#ventaMontoNeto').text());
            $('#borradorIVA').text($('#ventaIVA19').text());
            $('#borradorTotal').text($('#ventaMontoTotal').text());
