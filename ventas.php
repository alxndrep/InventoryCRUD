      ...
      <!-- Main -->
        <div id="main">
          <div class="inner">
            ...
            <header id="header">
              <div class="logo">
                <a href="home.php">Libreria Diego</a>
              </div>
            </header>
            ...
            <section class="services">
              <div class="container-fluid">
                <div class="row">
                  <div class="col-md-4">
                    <div class="service-item first-item" onclick="window.location='new_ventas.php';">
                      <div class="icon"><img src='assets/images/add_document.svg'></div>
                      <h4>Nueva Venta</h4>
                      <p>Realiza una nueva venta, agregando el cliente en especifico y sus productos con las cantidades correspondientes.</p>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="service-item fourth-item" onclick="window.location='import_ventas.php';">
                      <div class="icon"><img src='assets/images/import_document.svg'></div>
                      <h4>Importar Venta</h4>
                      <p>Importa una factura o borrador al sistema con tan solo un click.</p>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="service-item second-item" onclick="window.location='allventas2.php';">
                      <div class="icon"><img src='assets/images/form-venta.svg'></div>
                      <h4>Ver Ventas</h4>
                      <p>Revisa las ventas realizadas en el sistema y las importadas, podras buscar por numero de folio o cliente.</p>
                    </div>
                  </div>
                </div>
              </div>
