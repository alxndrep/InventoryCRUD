...
<body class="is-preload">
  <input type="hidden" name="ventaid" id="editventa_id" value="<?php echo $_POST['venta_id']?>">
    <!-- Wrapper -->
    <div id="wrapper">
                      ...
                      <form id="nventa">
                        ...
                        <div class="row" style="margin-bottom: 10px;">
                          ...
                          <div class="form-group col-md-3">
                            ...
                            <input type="number" class="form-control" id="nvfolio" placeholder="Dejar vacio si no se posee nro. de folio" disabled>
                          </div>
                        </div>
                        <div class="row" style="margin-bottom: 10px;">
                          <div class="form-group col-md-6">
                        ...
                        <div class="row" style="margin-bottom: 10px;"> 
                          ...
                          <div class="form-group col-md-6">
                            <label for="nvvendedor">Vendedor</label><br/>
                            <select class="selectpicker show-tick" data-width="auto" id="nvvendedor">
            ...
            <div class="modal-content">
              <div class="modal-body">
                <div class="alert alert-warning" role="alert">
                  <strong>Esta a punto de editar la venta.</strong> <br/><small>Puede visualizar el documento del borrador generado automaticamente de la venta presionando el boton correspondiente.</small>
                </div>
              </div>
...
<script src="edit_ventas.js"></script>
